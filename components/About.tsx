    ...
    <>
      ...
      <section className="py-16 md:py-40 text-white relative z-20" id="sobre">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-white/50 text-[10px] md:text-[11px] font-bold uppercase tracking-[0.2em] mb-8 md:mb-12">
              Nossa História
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-24 items-start">
              <div className="space-y-6 md:space-y-12">
                <h2 className="text-[28px] sm:text-[42px] md:text-[56px] text-white text-balance leading-[1.15] text-left font-light tracking-tight">
                ...
                <motion.p 
                  ...
                  className="text-[15px] sm:text-[18px] md:text-[21px] text-slate-300 leading-relaxed font-light text-balance tracking-tight"
                >
              ...
              >
                <div className="relative aspect-[16/10] rounded-[1.75rem] md:rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl bg-slate-800">
                  <Image 
                ...
                <div className="space-y-6">
                  <p className="text-[14px] sm:text-[16px] md:text-[18px] text-white/50 leading-relaxed font-light">
                  ...
                  <div className="flex items-center gap-4 md:gap-6">
                    <div className="h-px w-12 md:w-16 bg-secondary/40" />
                    <p className="text-[9px] md:text-[11px] uppercase tracking-[0.3em] text-secondary font-bold">
