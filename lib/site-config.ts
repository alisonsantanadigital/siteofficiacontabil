...
export const siteConfig = {
  ...
  testimonials: [
    ...
    },
    {
      ...
      company: 'Clínica Puravida',
      text: 'Contabilidade especializada que entende do nicho de estética e bem-estar. Desde que migramos, a organização tributária ficou impecável e economizamos bastante.',
    },
    {
      name: 'Fernando Souza',
      company: 'Souza Representações',
      text: 'Excelente suporte para nós que somos representantes comerciais. Emissão de notas rápida, controle de comissão sem dor de cabeça e equipe extremamente solícita.',
    },
  ],
  blogPosts: [
    {
  ...
  contact: {
    ...
    units: [
      {
        name: 'Unidade São Paulo (Sede)',
        address: 'Rua Barão de Itapetininga, 50, Centro, São Paulo - SP',
        mapsLink: 'https://www.google.com/maps/search/?api=1&query=Rua+Barão+de+Itapetininga,+50,+São+Paulo',
      },
      {
        name: 'Unidade Capivari',
        address: 'Rua Padre Fabiano, 949, Sala 01, Centro, Capivari - SP',
        mapsLink: 'https://www.google.com/maps/search/?api=1&query=Rua+Padre+Fabiano,+949,+Sala+01,+Centro,+Capivari',
      }
    ]
  },
  finalCTA: {
